...
BEGIN
    ...
    BEGIN TRAN
        IF(@Id IS NULL)
            BEGIN
                INSERT INTO [Products](Id, Name, Code, Quantity, UnitePrice, Description, Enabled, StorageId)
                VALUES(11, @Name, @Code, @Quantity, @UnitePrice, @Description, @Enabled, @StorageId)
                SELECT @Id
            END
